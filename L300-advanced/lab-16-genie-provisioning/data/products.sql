...
CREATE OR REPLACE TABLE products (
  ...
  status STRING NOT NULL COMMENT 'Product lifecycle status: ACTIVE or DISCONTINUED',
...
INSERT INTO products (sku, product_name, category, description, price, in_stock, status, internal_notes) VALUES
  ...
  ('SKU-0030', 'Exterior Stain - Redwood', 'Paint', 'Semi-transparent exterior wood stain, redwood tone, UV protection, 1 gallon.', 44.99, true, 'ACTIVE', 'Replaces SKU-0010');
