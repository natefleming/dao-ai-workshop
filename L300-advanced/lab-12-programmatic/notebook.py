...
# MAGIC
# MAGIC YAML is the default authoring path, but the same `AppConfig`
# MAGIC object model is exposed directly in Python. Useful when you need
# MAGIC to generate agents dynamically (one per tenant, one per dataset)
# MAGIC or embed dao-ai inside a larger Python application.
...
# MAGIC %pip install "dao-ai>=0.1.59"
...
# MAGIC databricks bundle run dao-ws-L300-advanced/lab-12-programmatic -t dev
